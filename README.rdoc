...
If this method gets called more than "threshold" times within "interval in seconds" Prop throws a Prop::RateLimitExceededError. You can chose to override the threshold for a given key:
...
These threshold methods can also be invoked without a key argument, in which case they act as if the key is nil.
